  ...
  return (
    <div className="flex justify-center items-center h-screen">
      ...
      <div className="w-full h-screen bg-white flex justify-center items-center">
        <div className="flex flex-col justify-center items-center bg-white rounded-lg px-16 py-8">
          <p className="text-lg mb-6">Are you signing up as a Sponsor or a School?</p>
          
          <Link to={'/signup/sponsor'}>
            <div className='flex flex-col items-center transform transition duration-300 hover:scale-110 cursor-pointer mb-8'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="bg-gray-100 rounded-full mb-2 p-8 size-50">
          ...
          <Link to={'/signup/school'}>
            <div className='flex flex-col items-center transform transition duration-300 hover:scale-110 cursor-pointer'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="bg-gray-100 rounded-full mb-2 p-8 size-50">
